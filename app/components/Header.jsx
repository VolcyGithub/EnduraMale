            ...
            <div className="flex items-center gap-x-4 lg:hidden">
              ...
              <div className="flex">
                <button
                  ...
                  className="outline-none py-3 px-4 relative"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                  ...
                  {/* Ajouter les deux spans pour les animations (les lignes transforment l'icône en croix) */}
                  <span
                    aria-hidden="true"
                    className={`h-0.5 w-6 rounded bg-white transition duration-300 absolute top-1/2 left-1/2 transform -translate-x-1/2 ${
                      openNavbar ? "rotate-45 translate-y-[0.33rem]" : ""
                    }`}
                  />
                  <span
                    aria-hidden="true"
                    className={`mt-2 h-0.5 w-6 rounded bg-white transition duration-300 absolute top-1/2 left-1/2 transform -translate-x-1/2 ${
                      openNavbar ? "-rotate-45 -translate-y-[0.33rem]" : ""
                    }`}
                  />
                </button>
