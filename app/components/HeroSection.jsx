...
return (
    <div className="text-gray-500 flex gap-x-3">
        <span className="w-7 h-7 max-h-7 min-w-[1.75rem] bg-gray-900 text-secondary rounded-md flex items-center justify-center">
            ✓
        </span>
        {text}
    </div>
...
const HeroSection = () => {
  return (
    <section className="bg-secondary/50 py-8 mt-20">
      <div className="mx-auto lg:max-w-7xl w-full px-5 sm:px-10 md:px-12 lg:px-5 flex flex-col lg:flex-row lg:items-stretch gap-x-6">
        ...
        <div className="flex flex-1 relative lg:h-auto">
          <div className="relative h-max lg:absolute left-0 top-0 flex lg:h-full  lg:w-auto w-11/12">
            <span className="absolute top-0 left-32 w-3/5 aspect-square rounded-md -rotate-[30deg] translate-y-20 origin-center border border-gray-800" />
            <span className="absolute top-1/2 right-16 w-2/5 aspect-square rounded-md rotate-12 -translate-y-1/2 origin-center border border-gray-800" />
            <Image
